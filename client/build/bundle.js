...
/***/ function(module, exports, __webpack_require__) {
	...
	window.onload = function () {
	  ...
	  ReactDOM.render(React.createElement(Main, { style: divStyle }), document.getElementById('main-div'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var UserInput = __webpack_require__(160);
	var FoodView = __webpack_require__(161);
	var ExcerciseView = __webpack_require__(163);
	var Exercise = __webpack_require__(164);
	...
	var Main = React.createClass({
	  ...
	  getInitialState: function getInitialState() {
	    return {
	      userStats: {},
	      view: React.createElement(UserInput, { setUserStats: this.setUserStats }),
	      results: [],
	      selectedResult: null,
	      excercises: []
	    };
	  ...
	  updateSelectedResult: function updateSelectedResult(values) {
	  ...
	  loadExercises: function loadExercises() {
	  ...
	  updateExercises: function updateExercises(data) {
	    var excercises = [];
	  ...
	  setUserStats: function setUserStats(params) {
	    this.setState({ userStats: params });
	    this.changeToFoodInput();
	  },
	
	  changeToFoodInput: function changeToFoodInput() {
	    this.setState({ view: React.createElement(FoodView, { updateResults: this.updateResults, updateSelectedResult: this.updateSelectedResult, results: this.state.results, changeToExcerciseOutPut: this.changeToExcerciseOutPut }) });
	  },
	
	  changeToExcerciseOutPut: function changeToExcerciseOutPut() {
	    this.setState({ view: React.createElement(ExcerciseView, null) });
	  },
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'div',
	      { style: divStyle, className: 'row', id: 'main-container' },
	      React.createElement(
	        'div',
	        { className: 'col-12' },
	        this.state.view
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserInput = React.createClass({
	  ...
	  handleAgeChange: function handleAgeChange(event) {
	    this.setState({ age: event.target.value });
	  },
	
	  handleWeightChange: function handleWeightChange(event) {
	    this.setState({ weight: event.target.value });
	  },
	
	  handleHeightChange: function handleHeightChange(event) {
	    this.setState({ height: event.target.value });
	  },
	
	  handleGenderChange: function handleGenderChange(event) {
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                ...
	                React.createElement(
	                  "div",
	                  { className: "col-12" },
	                  React.createElement("input", { onChange: this.handleAgeChange, className: "user-input", type: "number", placeholder: "Age" })
	                )
	              ),
	              React.createElement(
	                "div",
	                ...
	                React.createElement(
	                  "div",
	                  { className: "col-12" },
	                  React.createElement("input", { onChange: this.handleHeightChange, className: "user-input", type: "number", placeholder: "Height CM" })
	                )
	              ),
	              React.createElement(
	                "div",
	                ...
	                React.createElement(
	                  "div",
	                  { className: "col-12" },
	                  React.createElement("input", { onChange: this.handleWeightChange, className: "user-input", type: "number", placeholder: "Weight KG" })
	                )
	              ),
	              React.createElement(
	                "div",
	                ...
	                React.createElement(
	                  ...
	                  React.createElement(
	                    "select",
	                    { onChange: this.handleGenderChange, className: "user-input" },
	                    React.createElement(
	                      "option",
	                      { value: "male" },
	                      "Male"
	              ...
	              React.createElement(
	                ...
	                React.createElement(
	                  ...
	                  React.createElement(
	                    "button",
	                    { className: "user-input", onClick: this.handleClick },
	                    "OK"
	                  )
	                )
	              )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Food = __webpack_require__(162);
	...
	var FoodInput = React.createClass({
	  ...
	  populateNodes: function populateNodes(data) {
	    var newNodes = [];
	    for (var i = 0; i < data.hits.length; i++) {
	      var info = data.hits[i].fields;
	      newNodes.push(React.createElement('option', { key: i, value: info.item_name + "-" + info.brand_name + "-" + info.nf_calories }));
	    }
	    this.setState({ optionNodes: newNodes });
	  },
	
	  getFoodData: function getFoodData(text) {
	  ...
	  updateResults: function updateResults(data) {
	    ...
	    try {
	      for (var _iterator = data.hits[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	        var result = _step.value;
	  ...
	  findSelectedFood: function findSelectedFood(values) {
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'div',
	            { className: 'col-12' },
	            React.createElement('input', { onChange: this.handleChange, list: 'foods', name: 'foods' }),
	            React.createElement(
	              'datalist',
	              { id: 'foods' },
...
/***/ function(module, exports) {
	...
	var Food = function Food(params) {
	  this.foodName = params.foodName, this.brandName = params.brandName, this.calories = params.calories, this.fat = params.fat, this.servingSize = params.servingSize;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ExcerciseView = React.createClass({
	  displayName: "ExcerciseView",
...
/***/ function(module, exports) {
	...
	var Exercise = function Exercise(params) {
	  this.name = params.name, this.intensity = params.intensity, this.discription = params.discription;
	};
